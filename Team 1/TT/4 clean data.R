clean_data <- function(){
  ...
  harrypotter_token_clean <- harrypotterSeries %>%
  ...
  save(harrypotterSeries, file = "TT/data/harrypotterSeries.Rda")
  save(harrypotter_token_clean, file = "TT/data/harrypotter_token_clean.Rda")
